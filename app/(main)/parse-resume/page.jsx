...
import ResumeRanking from "../dashboard/create-interview/_components/ResumeRanking";

import { analyzeResumes } from "@/services/resumeAnalysis";
import { motion, AnimatePresence } from "framer-motion";
import { toast } from "sonner";
import ResumeDropzone from "../dashboard/create-interview/_components/ResumeDropzone";
...
const ResumeParsing = () => {
  ...
  const handleResumeUpload = (resumes) => {
    if (resumes.length > 0) {
      setIsUploading(true);
