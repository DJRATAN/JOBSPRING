...
const ResumeRanking = ({ scores }) => {
    const erroredFiles = useResumeStore((state) => state.currentErroredFiles);

    const [sortedScores, setSortedScores] = React.useState([]);
    const [previousRanks, setPreviousRanks] = React.useState({});
    ...
    const [showRankChanges, setShowRankChanges] = React.useState({});
    const [isFilterActive, setIsFilterActive] = React.useState(false);
    const [sortCriteria, setSortCriteria] = React.useState("overall");
    ...
    const handleCardClick = useCallback((resumeId) => {
    ...
    const handleSortCriteriaChange = useCallback((value) => {
                                                    ...
                                                    <div className="rank-badge">
                                                        ...
                                                        {showRankChanges[score.resumeId] && previousRanks[score.resumeId] !== undefined && (
                                                            <motion.div
                                                                ...
                                                                className={`rank-change ${previousRanks[score.resumeId] > index ? 'bg-green-500 text-white' : 'bg-red-500 text-white'
                                                                    }`}
                                                            >
