...
const ResumeDetailView = ({ score,onBack }) => {
  ...
  return (
    <Card className="shadow-lg border-resume-border animate-fade-in">
      <CardHeader className="flex flex-row items-center justify-between pb-2">
        ...
        <div className={`score-badge score-badge-${score.overallScore >= 80 ? "high" : score.overallScore >= 60 ? "medium" : "low"
                      ...
                      >
                        <div className="flex justify-between items-center">
                          ...
                          <div className="flex items-center gap-2">
                            <span className={`text-sm font-bold ${detail.score >= 80 ? 'text-green-600' :
